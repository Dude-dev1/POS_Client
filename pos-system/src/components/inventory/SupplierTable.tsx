              ...
              Array.from({ length: 5 }).map((_, i) => (
                <TableRow key={i}>
                  ...
                  <TableCell className="text-right">
                    <div className="h-4 w-8 animate-pulse bg-muted rounded ml-auto" />
                  </TableCell>
                </TableRow>
              ))
                  ...
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuSeparator />
                        <DropdownMenuItem
                          className="text-destructive hover:text-popover-foreground hover:bg-destructive/10 focus:bg-destructive/10 focus:text-popover-foreground"
                          onClick={() => {
                            setSelectedSupplier(supplier);
