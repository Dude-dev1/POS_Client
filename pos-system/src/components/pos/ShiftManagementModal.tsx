...
export function ShiftManagementModal({
  ...
  const fetchShiftStats = async () => {
    ...
    stats.expectedCash =
      Number(currentShift.opening_cash) + stats.paymentMethods.CASH;
    setShiftStats(stats);
  };
            ...
            <div className="bg-primary/5 p-4 rounded-xl border border-primary/10 flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Enter the starting cash amount currently in your drawer.
                </p>
              </div>
            </div>
          ...
          <div className="space-y-6 py-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <Card className="bg-green-50/50 border-green-100">
                <CardContent className="p-4">
                  <p className="text-[10px] text-green-600 uppercase font-black tracking-wider mb-1">
                    Expected Cash
                  </p>
              ...
              <Card className="bg-blue-50/50 border-blue-100">
                <CardContent className="p-4">
                  <p className="text-[10px] text-blue-600 uppercase font-black tracking-wider mb-1">
                    Total Sales
                  </p>
                  <p className="text-xl font-bold">
                    {formatCurrency(shiftStats.totalSales)}
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex justify-between text-sm">
                <span className="text-muted-foreground flex items-center gap-2">
                  <Wallet className="h-4 w-4" /> Opening Cash
                </span>
              ...
              <div className="flex justify-between text-sm">
                <span className="text-muted-foreground flex items-center gap-2">
                  <TrendingUp className="h-4 w-4" /> Cash Sales
                </span>
                <span className="font-medium">
              ...
              <div className="flex justify-between text-sm text-purple-600">
                ...
                <span className="font-bold">
                  {formatCurrency(shiftStats.paymentMethods.MOBILE_MONEY)}
                </span>
              </div>
            ...
            <div className="space-y-2 pt-4 border-t">
              ...
              <p className="text-[10px] text-muted-foreground italic">
                Difference:{" "}
                {formatCurrency(
                  (parseFloat(closingCashActual) || 0) - shiftStats.expectedCash
                )}
              </p>
            </div>
