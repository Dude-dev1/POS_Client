...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {(isAdmin || isManager) && (
        <div className="rounded-xl border border-dashed border-border p-6 flex flex-col items-center justify-center space-y-1">
          <div className="flex items-center justify-center gap-2 text-primary">
            <Activity className="h-6 w-6" />
            <p className="text-sm font-semibold">Advanced Analytics</p>
          </div>
          <p className="text-xs text-muted-foreground">
            Head to the <strong>Reports</strong> section for full sales
            breakdowns, product performance, and payment analysis.
          </p>
        </div>
      )}
    </div>
